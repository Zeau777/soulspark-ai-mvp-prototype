    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Founded by a diverse team passionate about faith, technology, and social good, SoulSpark AI was born from a simple yet profound idea: wellness apps often overlook the soul. Inspired by the rising stress and disconnection among Gen Z and Millennials, we created a platform that meets you where you are—spiritually and emotionally. Our beta program is already sparking change, with early users praising its impact on their daily lives.
          </p>
        </div>
      </section>
